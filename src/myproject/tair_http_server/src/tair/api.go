...
#include <stdlib.h>
#include "tair_clib.h"
#cgo CFLAGS: -I /code/tair_http_server/c -I /code/tair_http_server/c/include/tbnet -I /code/tair_http_server/c/include/tbsys
#cgo LDFLAGS: -L /code/tair_http_server/c/lib -ltbsys -ltbnet -ltair_clib
*/
import "C"
...
func Init() error {
	//once.Do(tairLoadConf(master,slave,port))
	//
